...
import com.hangeulbot.repository.*;
...
public class APIDaoImpl implements APIDao{
    ...
    @Autowired
    private HangeulbotChoPhoenixRepository hangeulbotChoPhoenixRepository;
    @Autowired
    private HangeulbotJungPhoenixRepository hangeulbotJungPhoenixRepository;
    @Autowired
    private HangeulbotJongPhoenixRepository hangeulbotJongPhoenixRepository;
    ...
    */
    ...
    @Override
    public HangeulbotChoPhoenix getChoPhoenixByChoSungAndHangeulbotChild(char cho, HangeulbotChild hangeulbotchild) {
        return hangeulbotChoPhoenixRepository.findByChoSungAndHangeulbotChild(cho,hangeulbotchild);
    }

    @Override
    public void saveChoPhoenix(HangeulbotChoPhoenix hangeulbotChoPhoenix) {
        hangeulbotChoPhoenixRepository.save(hangeulbotChoPhoenix);
    }

    @Override
    public HangeulbotJungPhoenix getJungPhoenixByJungSungAndHangeulbotChild(char jun, HangeulbotChild hangeulbotchild) {
        return hangeulbotJungPhoenixRepository.findByJungSungAndHangeulbotChild(jun,hangeulbotchild);
    }

    @Override
    public void saveJungPhoenix(HangeulbotJungPhoenix hangeulbotJungPhoenix) {
        hangeulbotJungPhoenixRepository.save(hangeulbotJungPhoenix);
    }

    @Override
    public HangeulbotJongPhoenix getJongPhoenixByJongSungAndHangeulbotChild(char jon, HangeulbotChild hangeulbotchild) {
        return hangeulbotJongPhoenixRepository.findByJongSungAndHangeulbotChild(jon,hangeulbotchild);
    }

    @Override
    public void saveJongPhoenix(HangeulbotJongPhoenix hangeulbotJongPhoenix) {
        hangeulbotJongPhoenixRepository.save(hangeulbotJongPhoenix);

    }

    @Override
    public List<HangeulbotWordAchievement> getWordAchievementInfoByHangeulbotChild(HangeulbotChild hangeulbotChild) {
        return hangeulbotWordAchievementRepository.getByHangeulbotChild(hangeulbotChild);
    }
    ...
    public Float getAnotherStudyAchievement(int i, String childId) {
        String sql = "select sum(hwg.word_grade)/count(*)\n" +
                ...
                "             (SELECT child_birth\n" +
                "              FROM hangeulbot_child\n" +
                "              WHERE child_id = 'imvestt@hanmail.net_0'), INTERVAL -1 MONTH)\n" +
                "         AND\n" +
                "           date(child_birth) < date_add(\n" +
                "              (SELECT child_birth\n" +
                "               FROM hangeulbot_child\n" +
                "               WHERE child_id = 'imvestt@hanmail.net_0'), INTERVAL -0 MONTH)\n" +
                "\n" +
                "        )\n" +
                "      AND\n" +
                "      huwl.word_id = hwg.word_id\n" +
